...
function SWEP:ShootEffects()
    if CLIENT and not LocalPlayer():IsGhost() then return end
...
function SWEP:FireAnimationEvent(pos, ang, ev)
    if CLIENT and not LocalPlayer():IsGhost() then return true end
end
...
function SWEP:GetViewModelPosition(pos, ang)
    if not self.IronSightsPos or not self.bIron then return pos, ang end
