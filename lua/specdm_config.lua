...
-- Chat commands
SpecDM.Commands = {"!dm", "!deathmatch", "!specdm"}
...
SpecDM.Ghost_weapons = {
    secondary = {"weapon_ghost_glock", "weapon_ghost_pistol", "weapon_ghost_revolver", "weapon_ghost_magnum"},
    primary = {"weapon_ghost_ak47", "weapon_ghost_augbar", "weapon_ghost_awp", "weapon_ghost_galil", "weapon_ghost_sledge", "weapon_ghost_mac10", "weapon_ghost_hl2smg", "weapon_ghost_mp5", "weapon_ghost_shotgun", "weapon_ghost_rifle"}
}
...
SpecDM.AllowedGroups = {"admin", "superadmin"}
